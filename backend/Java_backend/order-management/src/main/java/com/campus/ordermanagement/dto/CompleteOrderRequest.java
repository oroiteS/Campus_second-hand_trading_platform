...
public class CompleteOrderRequest {
     ...
     * 备注信息（可选）
     */
    @Schema(description = "备注信息", example = "订单已完成")
    ...
    // 带参构造函数
    public CompleteOrderRequest(String orderId) {
        this.orderId = orderId;
    }

    public CompleteOrderRequest(String orderId, String operatorId) {
        this.orderId = orderId;
