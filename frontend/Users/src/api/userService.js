    ...
    if (adminToken && adminToken.startsWith('admin-test-token-')) {
      return new Promise((resolve) => {
        ...
        setTimeout(() => {
          // 模拟用户数据
          const allUsers = [
            { id: 1, username: '张三', school: '北京大学', registerTime: '2023-01-15', status: 'active' },
            { id: 2, username: '李四', school: '清华大学', registerTime: '2023-02-20', status: 'active' },
            { id: 3, username: '王五', school: '复旦大学', registerTime: '2023-03-10', status: 'disabled' },
            { id: 4, username: '赵六', school: '浙江大学', registerTime: '2023-03-15', status: 'active' },
            { id: 5, username: '钱七', school: '南京大学', registerTime: '2023-04-01', status: 'active' },
            { id: 6, username: '孙八', school: '武汉大学', registerTime: '2023-04-10', status: 'disabled' },
            { id: 7, username: '周九', school: '上海交通大学', registerTime: '2023-04-15', status: 'active' },
            { id: 8, username: '吴十', school: '中国科学技术大学', registerTime: '2023-04-20', status: 'active' },
            { id: 9, username: '郑十一', school: '哈尔滨工业大学', registerTime: '2023-05-01', status: 'disabled' },
            { id: 10, username: '王十二', school: '西安交通大学', registerTime: '2023-05-10', status: 'active' },
            { id: 11, username: '李十三', school: '南开大学', registerTime: '2023-05-15', status: 'active' },
            { id: 12, username: '赵十四', school: '天津大学', registerTime: '2023-05-20', status: 'disabled' },
            { id: 13, username: '钱十五', school: '同济大学', registerTime: '2023-06-01', status: 'active' },
            { id: 14, username: '孙十六', school: '华中科技大学', registerTime: '2023-06-10', status: 'active' },
            { id: 15, username: '周十七', school: '北京航空航天大学', registerTime: '2023-06-15', status: 'disabled' }
          ];
          
          // 根据状态筛选
          let filteredUsers = allUsers;
          if (params && params.status) {
            filteredUsers = allUsers.filter(user => user.status === params.status);
          }
      ...
      return new Promise((resolve) => {
        ...
        setTimeout(() => {
          ...
          let announcements = JSON.parse(localStorage.getItem('testAnnouncements')) || [
            { id: 1, title: '系统维护通知', content: '系统将于2023年8月1日凌晨2点至4点进行维护，期间可能无法访问。', publishTime: '2023-07-25 14:30:00' },
